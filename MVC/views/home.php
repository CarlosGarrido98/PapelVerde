...
<main> 
 <!-- Section -->
    ...
    <h2 class="text-center my-4" style="color: #254B36;">
        Ofertas especiales
    </h2>
                ...
                <div class="card rounded-4 shadow h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button class="btn-añadir d-none d-xl-block">
                                Añadir <i class="bi bi-plus"></i>
                            </button>

                            <button class="btn-añadir position-absolute bottom-0 end-0 bi bi-plus-lg d-xl-none d-block">
                            </button>
